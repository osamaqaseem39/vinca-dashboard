...
const AddProductForm = ({ onSubmit, onCancel, isLoading }: AddProductFormProps) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        {(!formData.images || formData.images.length === 0) && (
          <p className="text-sm text-red-600 font-medium mt-1">At least one image is required</p>
        )}
      </div>
      ...
      <div className="flex gap-3 justify-end pt-4 border-t-2 border-black">
        ...
        <Button type="submit" disabled={isLoading || !formData.name || !formData.brand || !formData.sku || (formData.images?.length || 0) === 0}>
